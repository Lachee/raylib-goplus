...
func main() {
	...
	dwarf := rl.LoadModel("../resources/dwarf.obj")             // Load OBJ model
	texture := rl.LoadTexture("../resources/dwarf_diffuse.png") // Load model texture

	dwarf.Material.Maps[rl.MapDiffuse].Texture = texture // Set dwarf model diffuse texture

	position := rl.NewVector3(0.0, 0.0, 0.0) // Set model position

	shader := rl.LoadShader("../resources/glsl330/base.vs", "../resources/glsl330/swirl.fs") // Load postpro shader
