...
//------------------------------------------------------------------------------------
#convert:group:input
#convert:enum:Gamepad.*int button:GamepadButton
...
//------------------------------------------------------------------------------------
#convert:group:texture
#convert:enum:TextureFilter.*int filterMode:TextureFilterMode
#convert:enum:TextureFilter.*int wrapMode:TextureWrapMode
#convert:oop:begin
...
//------------------------------------------------------------------------------------
#convert:group:models
#convert:enum:mapType:MaterialMapType
#convert:oop:begin
...
//------------------------------------------------------------------------------------
#convert:group:shader
#convert:enum:Shader.*int uniformType:ShaderUniformDataType
#convert:enum:Blend.*int mode:BlendMode
